...
public class OrderHistoryListAdapter extends BaseAdapter {
    ...
    public static class OrderHistoryViewHolder {
        TextView order_id, order_date, order_products, order_customer_name, order_total, order_status;
        int position;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (cell == null) {
            ...
            viewHolder.order_status =(TextView)cell.findViewById(R.id.order_status);
        ...
        viewHolder.order_status.setText(currentData.get(5));
        return cell;
